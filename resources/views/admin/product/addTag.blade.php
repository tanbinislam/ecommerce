<x-app-layout>
    <x-dash.page-title>Create Product Tag</x-dash.page-title>
    <div class="row align-items-center">
        <div class="col-12">                      
        <form id="product-form" class="form-horizontal" method="post" action="{{ route('storeProductTag') }}" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-header card_header">
                    <div class="row">
                        <div class="col-md-8 card_header_title">
                        <i class="mdi mdi-contactless-payment-circle"></i> Add New Product Tag
                        </div>
