            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row border border-info rounded">
                        <div class="col-12 mb-3 text-center bg-info text-white">
                            <h3>-- PRODUCT --</h3>
                        </div>
                        <div class="col-12">
                            <form id="product-form" class="form-horizontal px-2">
                    ...
                    <div class="row my-4 border border-info rounded">
                        <div class="col-12 mb-3 bg-info text-white text-center">
                            <h3>-- Stock --</h3>
                        </div>
                        <div class="col-12">
                            {{-- wizard --}}
                            <div id="product-wizard">
                                <ul style="margin-left:0px; margin-right:0px; " id="wiz-tab" class="nav nav-pills nav-justified form-wizard-header mb-4" role="tablist">
                                    <li class="nav-item">
                                ...
                                <div class="tab-content b-0 pb-0">
                                    <div class="tab-pane px-5 py-2 active" id="tab-general">
                                        <div class="row">
                                            <div class="col-12">
                                    ...
                                    <div class="tab-pane px-5 py-2" id="tab-color">
                                        <div class="row">
                                            <div class="col-12">
                                    ...
                                    <div class="tab-pane px-5 py-2" id="tab-size">
                                        <div class="row">
                                            <div class="col-12">
                                                    ...
                                                    <div role="tabpanel" class="row">
                                                        <div class="col-12 mb-6">
                                                            <div class="row mb-2">
                                                                ...
                                                                <div class="col-2">
                                                                    <input type="number" value="0" name="size[xxl][qty]" id="sz-xxl-qty" class="form-control mt-1">
                                                                </div>
                                                                <div class="col-8">
                                                                    <span class="invalid-feedback" role="alert" style="display: block;">
                                                            ...
                                                            <div class="row mb-2">
                                                                ...
                                                                <div class="col-2">
                                                                    <input type="number" value="0" name="size[xl][qty]" id="sz-xl-qty" class="form-control mt-1">
                                                                </div>
                                                                <div class="col-8">
                                                                    <span class="invalid-feedback" role="alert" style="display: block;">
                                                            ...
                                                            <div class="row mb-2">
                                                                ...
                                                                <div class="col-2">
                                                                    <input type="number" value="0" name="size[l][qty]" id="sz-l-qty" class="form-control mt-1">
                                                                </div>
                                                                <div class="col-8">
                                                                    <span class="invalid-feedback" role="alert" style="display: block;">
                                                            ...
                                                            <div class="row mb-2">
                                                                ...
                                                                <div class="col-2">
                                                                    <input type="number" value="0" name="size[m][qty]" id="sz-m-qty" class="form-control mt-1">
                                                                </div>
                                                                <div class="col-8">
                                                                    <span class="invalid-feedback" role="alert" style="display: block;">
                                                            ...
                                                            <div class="row mb-2">
                                                                ...
                                                                <div class="col-2">
                                                                    <input type="number" value="0" name="size[s][qty]" id="sz-s-qty" class="form-control mt-1">
                                                                </div>
                                                                <div class="col-8">
                                                                    <span class="invalid-feedback" role="alert" style="display: block;">
                                    ...
                                    <div class="tab-pane px-5 py-2" id="tab-color-size">
                                        <div class="row">
                                            <div class="col-12">
                    ...
                    <div class="row mb-2 justify-content-center border border-info rounded">
                        <div class="col-12 mb-3 bg-info text-white text-center">
                            <h3>-- Images --</h3>
                        </div>
                        <div class="col-12">
            ...
            $("#product-form").on('submit', function(e){
                ...
                $.ajax({
                    ...
                    success : function(response){
                        ...
                        dz = new Dropzone("#image-upload-form", {
                                url: '/shop/product-images/'+response.product_id,
                                paramName: 'images',
