<x-app-layout>
    <x-dash.page-title>Deleted Products</x-dash.page-title>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                        ...
                        <table class="table table-centered dt-responsive nowrap w-100" id="all-datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-name="Product" data-title="{{$product->title}}" href="#" data-url="{{route('restoreProduct', ['id' => $product->id])}}" class="dtbl-icon action-icon restore-dta" title="Restore"> <i class="mdi mdi-restore"></i></a>
                                        <a data-name="Product" data-title="{{$product->title}}" href="#" data-url="{{route('permanentDeleteProduct', ['id' => $product->id])}}" class="dtbl-icon action-icon permanent-delete-dta" title="Permanent Delete"> <i class="mdi mdi-delete"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
