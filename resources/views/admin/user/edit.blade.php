<x-app-layout>
    <x-dash.page-title>Edit Users Information</x-dash.page-title>
    <div class="row align-items-center">
        <div class="col-12">                      
        <form class="form-horizontal" method="post" action="{{ route('updateUser', ['user' => $user]) }}" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-header card_header">
                    <div class="row">
                        <div class="col-md-8 card_header_title">
                        <i class="mdi mdi-contactless-payment-circle"></i> User Information update
                        </div>
                ...
                <div class="card-body card_body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-8">
                            <input type="phone" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ $user->phone == '' ? '' : $user->phone}}">
                            <div class="row">
                                <div class="col-6">
                                    @if ($errors->has('phone'))
                                    <span class="invalid-feedback" role="alert">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-8">
                            ...
                            <div class="form-check form-checkbox-success mb-2">
                                <input value="{{ $role->name }}" name="role[]" type="checkbox" class="form-check-input" id="{{'role-'.Str::slug($role->name, '-')}}" {{ $user->hasRole($role->name) ? 'checked' : ''}}>
